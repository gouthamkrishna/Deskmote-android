...
public class SetReminder extends ActionBarActivity implements AdapterView.OnItemClickListener {
   ...
   public void setCurrentDateOnView() {
       ...
       tvDisplayDate = (TextView)findViewById(R.id.textView3);
       tvDisplayTime = (TextView)findViewById(R.id.textView2);
    ...
    public void addListenerOnButton() {
        ...
        btnChangeDate = (ImageView) findViewById(R.id.button1);
    ...
    public void addListenerOnButton2() {
        ...
        btnChangeDate = (ImageView) findViewById(R.id.button3);
