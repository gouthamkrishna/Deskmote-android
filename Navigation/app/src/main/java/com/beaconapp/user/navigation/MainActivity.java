...
public class MainActivity extends ActionBarActivity  {
    ...
    String NAME = "Elizabeth George";
    String EMAIL = "elizabethgeorge94@gmail.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TITLES = new String[]{"Home", "Statistics", "Notifications", "Profile", "Settings"};
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                switch (position){
                    ...
                    case 2:resetAdapter();
                        ...
                        break;
                    case 3:resetAdapter();
                        FragmentTransaction ax = getSupportFragmentManager().beginTransaction();
                        ax.replace(R.id.container, Fragment.instantiate(MainActivity.this, "com.beaconapp.user.navigation.NotificationFragment"));
                        ax.commit();
                        ...
                        break;
                    case 4:resetAdapter();
                        FragmentTransaction bx = getSupportFragmentManager().beginTransaction();
                        bx.replace(R.id.container, Fragment.instantiate(MainActivity.this, "com.beaconapp.user.navigation.ProfileFragment"));
                        bx.commit();
                        ...
                        break;
                    case 5:resetAdapter();
                        FragmentTransaction cx = getSupportFragmentManager().beginTransaction();
                        cx.replace(R.id.container, Fragment.instantiate(MainActivity.this, "com.beaconapp.user.navigation.SettingsFragment"));
                        cx.commit();
